...
###### `v2.9.5`
- fix(simple-line-icons): Can't resolve simple-line-icons.css
...
###### `v2.9.3`
- refactor(advanced-forms): move styleUrls to component scss file 
- fix(datepicker): missing dark theme 

###### `v2.9.2`
- fix(navbars): `CollapseDirective` cannot find module `ngx-bootstrap`
- fix(advanced-forms): `TimepickerModule` cannot find module `ngx-bootstrap`
- fix(text-editors): import `QuillModule` missing root injector 
- fix(draggable): `ng2-dragula` group named 'GROUP_ONE' already exists
- fix(datatable): workaround for sorter icon
- fix(routes): missing default module `redirectTo`
...
- update `angular-calendar` to `^0.28.5`
- update `angular2-toaster` to `^8.0.0`
...
- update `ngx-quill` to `^8.1.3`
- update `rxjs` to `^6.5.5`
- update `rxjs-compat` to `^6.5.5`
...
- update `flag-icon-css` to `^3.4.6`
- update `ngx-bootstrap` to `^5.5.0`
- update `rxjs` to `^6.5.4`
- update `rxjs-compat` to `^6.5.4`
...
- update `@coreui/coreui-pro` to `^2.1.16`
...
- update `angular-calendar` to `^0.27.11`
...
- chore(tslint): remove deprecated/undefined rules  
...
###### `v2.4.5`
- refactor(draggable): update `ng2-dragula` to v2.1.1
- fix(draggable): cannot drag to an empty column
- refactor(modals): add `@ViewChild`

###### depencencies update
- update: `@coreui/angular` to `^2.4.5`
- update: `@coreui/coreui-pro` to `^2.1.11`
- update: `@agm/core` to `^1.0.0-beta.6`
- update: `@angular/animations` to `^7.2.15`
- update: `@angular/common` to `^7.2.15`
- update: `@angular/compiler` to `^7.2.15`
- update: `@angular/core` to `^7.2.15`
- update: `@angular/forms` to `^7.2.15`
- update: `@angular/http` to `^7.2.15`
- update: `@angular/platform-browser` to `^7.2.15`
- update: `@angular/platform-browser-dynamic` to `^7.2.15`
- update: `@angular/router` to `^7.2.15`
- update: `@coreui/angular` to `~2.4.5`
- update: `@coreui/coreui-plugin-chartjs-custom-tooltips` to `^1.3.1`
- update: `angular-calendar` to `^0.27.8`
- update: `angular2-ladda` to `^2.0.1`
- update: `chart.js` to `^2.8.0`
- update: `core-js` to `^2.6.9`
- update: `flag-icon-css` to `^3.3.0`
- update: `ng-select` to `^1.0.2`
- update: `ng2-charts` to `2.2.3`
- update: `ng2-dragula` to `^2.1.1`
- update: `ngx-bootstrap` to `^4.2.0`
- update: `ngx-quill` to `^5.2.0`
- update: `rxjs` to `^6.5.2`
- update: `rxjs-compat` to `^6.5.2`
- update: `@angular-devkit/build-angular` to `^0.13.9`
- update: `@angular/cli` to `^7.3.9`
- update: `@angular/compiler-cli` to `^7.2.15`
- update: `@angular/language-service` to `^7.2.15`
...
- update: `@angular/animations` to `^7.2.7`
- update: `@angular/common` to `^7.2.7`
- update: `@angular/compiler` to `^7.2.7`
- update: `@angular/core` to `^7.2.7`
- update: `@angular/forms` to `^7.2.7`
- update: `@angular/http` to `^7.2.7`
- update: `@angular/platform-browser` to `^7.2.7`
- update: `@angular/platform-browser-dynamic` to `^7.2.7`
- update: `@angular/router` to `^7.2.7`
- update: `@angular-devkit/build-angular` to `^0.13.4`
- update: `@angular/cli` to `^7.3.4`
- update: `@angular/compiler-cli` to `^7.2.7`
- update: `@angular/language-service` to `^7.2.7`
- update: `angular-calendar` to `^0.26.6`
- update: `flag-icon-css` to `^3.3.0`
- update: `moment` to `^2.24.0`
- update: `ngx-bootstrap` to `^3.2.0`
- update: `ng2-charts` to `^2.0.0-beta.4`
- update: `ngx-perfect-scrollbar` to `^7.2.1`
- update: `ngx-quill` to `^4.6.12`
- update: `rxjs` to `^6.4.0`
- update: `rxjs-compat` to `^6.4.0`
- update: `tsickle` to `^0.34.3`
- update: `tslib` to `^1.9.3`
- update: `zone.js` to `^0.8.29`
- update: `@types/node` to `^11.10.4`
- update: `karma` to `^4.0.1`
- update: `ts-node` to `^8.0.2`
- update: `tslint` to `^5.13.1`
- refactor: modules with charts `import { ChartsModule } from 'ng2-charts';`

###### `v2.4.0`
- fix(sidebar): navItems reassignment bug 
...
- update: `date-fns` to `1.30.1`
- update: `ng2-ace-editor` to `^0.3.9`
- update: `ngx-quill` to `4.5.0`
...
- update: `angular-calendar` to `^0.26.4`
- update: `angular2-ladda` to `^2.0.0`
- update: `angular2-text-mask` to `^9.0.0`
- update: `angular2-toaster` to `^7.0.0`
- update: `core-js` to `^2.5.7`
- update: `moment` to `^2.22.2`
- update: `ng-select` to `^1.0.1`
- update: `ng2-charts` to `^1.6.0`
- update: `ngx-bootstrap` to `^3.1.2`
- update: `ngx-perfect-scrollbar` to `^7.1.0`
- update: `ngx-quill` to `^4.3.3`
- update: `ts-helpers` to `^1.1.2`
- update: `zone.js` to `^0.8.26`

- refactor(invoice): buttons add `d-print-none`
- fix: add missing badges
- refactor(spinners): tweaks & color for dark template
- refactor(ng-select): tweaks & color for dark template
- refactor(datatable): extract service, move to `HttpClient`, `HttpClientModule` 
...
###### `v2.0.1`
- refactor(calendar): tweak sample, scss   
- refactor(alerts): fix card-header-actions, spacing 
- refactor(toastr): buttons spacing
- feat(basic-forms): add missing date-input
- refactor(modals): buttons spacing
- refactor(brand-buttons): buttons spacing
- update: `@coreui/coreui-pro` to `2.0.20`
- update: `angular-calendar` to `0.26.3`
- update: `bootstrap` to `4.1.3`
- update: `ngx-quill` to `3.6.0`
- update: `quill` to `1.3.6`
- update: `date-fns` to `1.29.0`
